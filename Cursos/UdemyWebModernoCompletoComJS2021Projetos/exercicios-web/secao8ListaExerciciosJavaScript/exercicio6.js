...
function calculaJurosCompostos(capitalEmprestado, taxaJuros, tempoMeses) {
  ...
  for (let i = 0; i < tempoMeses; i++) {
    capitalEmprestadoAcumulado += capitalEmprestadoAcumulado * taxaJuros;
  }
  return Math.floor(capitalEmprestadoAcumulado);
}

// Valores simulado casa verde e amarela taxa de juros ao ano
const capitalInicial = 120000;
const taxaJuros = 0.0425; // em porcentagem é so multiplicar por 100 10% para mostrar ao usuário
const tempoAplicação = 30;
