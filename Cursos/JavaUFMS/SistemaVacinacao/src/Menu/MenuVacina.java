...
public class MenuVacina{
	...
	private void  AlterarVacina(){
		if (listVacina.size() == 0) {
			System.out.println("Não Exitem Vacinas para alterar!");
			return;
		}
		int temVacina = 0;
			...
			if(v.getNomeVacina().equals(nomeVacina.toUpperCase())){
				...
				while(op != 0){
					...
					switch(op){
						...
						break;
						case 3:
							System.out.println("\nInforme a Nova Duração da Vacina " + v.getNomeVacina());
							v.setDuracao(in.nextInt());
							System.out.println("Duração alterado para: " + v.getDuracao()+" Meses\n");
						break;
						case 4:
							System.out.println("\nInforme a Nova Idade Mínima da Vacina " + v.getNomeVacina());
							v.setIdadeMinima(in.nextInt());
							System.out.println("Idade Mínima foi alterada para: " + v.getIdadeMinima()+" Anos\n");
						break;
						case 5:
						...
						break;
						case 6:
							System.out.println("\nInforme Porcentagem de Eficácia da Vacina " + v.getNomeVacina());
							v.setEficacia(in.nextInt());
							System.out.println("Eficácia da Vacina foi alterada para: " + v.getEficacia() + "%\n");
						break;
						case 7:
							System.out.println("\nInforme a Nova Restrição da Vacina " + v.getNomeVacina());
							v.setRestricoes(in.nextLine());
							System.out.println("Restrição foi alterada para: " + v.getRestricoes()+"\n");
						break;
						case 0:
	...
	private void deletarVacina() {
		if(listVacina.size() == 0){
			System.out.println("Não Existe Vacina para deletar!");
			return;
		}
