...
public class MenuVacina implements Menu {
	...
	public void cadastrar() {
		...
		if (nomeVacina != null && fabricante != null && duracao != null && idadeMinima != null && dose != null
				&& eficacia != null && restricoes != null) {
	...
	public Vacina consultarVacinaVacinar(String nomeVacina) {
		for (Vacina v : listVacina) {
			if (v.getNomeVacina().toUpperCase().equals(nomeVacina.toUpperCase())) {
				return v;
			}
