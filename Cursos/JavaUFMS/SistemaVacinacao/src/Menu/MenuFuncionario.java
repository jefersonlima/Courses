...
public class MenuFuncionario implements Menu {
	...
	public void cadastrar() {
		...
		funcionario = new Funcionario(nome, idade, sexo, cpf, celular, endereco, profissao, comorbidade, raca, gestante,
				codMatricula);
	...
	public Funcionario consultarFuncionarioVacinar(String nomeFuncionario) {
		for (Funcionario f : listFuncionario) {
			if (f.getNome().toUpperCase().equals(nomeFuncionario.toUpperCase())) {
				return f;
			}
	...
	public void popular() {
		...
		// Pessoas
		listFuncionario.add(new Funcionario("Gilson", 26, 'M', "87025384828", "(67) 99459-3797", endereco.get(0),
				"Designer", false, "Pardo", false, 0));
		listFuncionario.add(new Funcionario("Jeferson", 65, 'M', "98765432100", "(83) 99940-1105", endereco.get(1),
				"Professor", false, "Preto", false, 1));
		listFuncionario.add(new Funcionario("Henrique", 65, 'M', "54058291451", "(68)99164-9104", endereco.get(2),
				"Professor", true, "Branco", false, 2));
		listFuncionario.add(new Funcionario("Isadora", 50, 'F', "45457869369", "(62) 98528-9986", endereco.get(3),
				"Professor", false, "Parda", true, 3));
	}
}