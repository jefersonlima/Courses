...
public class Pessoa implements Verificavel {
	...
	public Pessoa(String nome, Integer idade, char sexo, String cpf, String celular, Endereco endereco,
		...
		if (validarCPF(cpf) == true) {
			...
			solicitarNovo(nome, idade, sexo, cpf, celular, endereco, profissao, comorbidade, raca, gestante);
		}
	}
	...
	public void solicitarNovo(String nome, Integer idade, char sexo, String cpf, String celular, Endereco endereco,
			String profissao, boolean comorbidade, String raca, boolean gestante) {
		System.out.println("CPF: " + cpf + " Invalido!\n Digite Novamente");
		String novoCpf = "00409163163";
		Pessoa pessoa = new Pessoa(nome, idade, sexo, novoCpf, celular, endereco, profissao, comorbidade, raca,
				gestante);
	}
